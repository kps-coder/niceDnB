    ...
    */
    ...
    function addVerticalNavigation() {
      ...
      for (var i = 0; i < getState().sections.length; i++) {
        ...
        li += '<li><a href="#' + encodeURI(link) + '"><span class="fp-sr-only">' + getBulletLinkName(section.index(), 'Section') + '</span><span class="num">'+ (i+1) + '</span></a>'; // Only add tooltip if needed (defined by user)
